...
SmartLogix es una aplicación de microservicios para la gestión integral de inventario y pedidos, implementado con una arquitectura basada en REST API y persistencia relacional.
